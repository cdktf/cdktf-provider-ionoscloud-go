...
func (v *jsiiProxy_VpnWireguardGatewayMaintenanceWindowOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnWireguardGatewayMaintenanceWindowOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
