...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.server.ServerConfig",
		reflect.TypeOf((*ServerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.server.ServerLabel",
		reflect.TypeOf((*ServerLabel)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.server.ServerLabelList",
		reflect.TypeOf((*ServerLabelList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServerLabelOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.server.ServerNic",
		reflect.TypeOf((*ServerNic)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.server.ServerNicFirewall",
		reflect.TypeOf((*ServerNicFirewall)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.server.ServerNicFirewallList",
		reflect.TypeOf((*ServerNicFirewallList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.server.ServerTimeouts",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.server.ServerVolume",
