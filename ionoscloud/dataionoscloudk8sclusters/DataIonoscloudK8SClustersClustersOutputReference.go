...
func (d *jsiiProxy_DataIonoscloudK8SClustersClustersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataIonoscloudK8SClustersClustersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
