...
func (j *jsiiProxy_S3BucketWebsiteConfiguration) ErrorDocumentInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"errorDocumentInput",
...
func (j *jsiiProxy_S3BucketWebsiteConfiguration) IndexDocumentInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"indexDocumentInput",
...
func (j *jsiiProxy_S3BucketWebsiteConfiguration) RedirectAllRequestsToInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
