...
func (j *jsiiProxy_S3BucketWebsiteConfigurationRoutingRuleRedirectOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_S3BucketWebsiteConfigurationRoutingRuleRedirectOutputReference)SetInternalValue(val interface{}) {
