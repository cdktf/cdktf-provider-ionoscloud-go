...
func NewDatacenterCpuArchitectureOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DatacenterCpuArchitectureOutputReference {
	...
	if err := validateNewDatacenterCpuArchitectureOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DatacenterCpuArchitectureOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DatacenterCpuArchitectureOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
