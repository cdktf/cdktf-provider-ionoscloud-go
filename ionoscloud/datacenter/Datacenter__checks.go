...
func (d *jsiiProxy_Datacenter) validatePutTimeoutsParameters(value *DatacenterTimeouts) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (j *jsiiProxy_Datacenter) validateSetDescriptionParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_Datacenter) validateSetLocationParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_Datacenter) validateSetSecAuthProtectionParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
