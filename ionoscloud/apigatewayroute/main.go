...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApigatewayRoute)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetWebsocket", GoMethod: "ResetWebsocket"},
			...
			_jsii_.MemberProperty{JsiiProperty: "websocketInput", GoGetter: "WebsocketInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.apigatewayRoute.ApigatewayRouteConfig",
		reflect.TypeOf((*ApigatewayRouteConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.apigatewayRoute.ApigatewayRouteTimeouts",
		reflect.TypeOf((*ApigatewayRouteTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.apigatewayRoute.ApigatewayRouteTimeoutsOutputReference",
		reflect.TypeOf((*ApigatewayRouteTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.apigatewayRoute.ApigatewayRouteUpstreams",
		reflect.TypeOf((*ApigatewayRouteUpstreams)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.apigatewayRoute.ApigatewayRouteUpstreamsList",
		reflect.TypeOf((*ApigatewayRouteUpstreamsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApigatewayRouteUpstreamsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
