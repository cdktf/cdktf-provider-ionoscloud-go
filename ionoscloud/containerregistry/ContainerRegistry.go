...
type ContainerRegistry interface {
	...
	GarbageCollectionSchedule() ContainerRegistryGarbageCollectionScheduleOutputReference
	GarbageCollectionScheduleInput() *ContainerRegistryGarbageCollectionSchedule
	Hostname() *string
	Id() *string
	SetId(val *string)
	IdInput() *string
	...
	StorageUsage() ContainerRegistryStorageUsageList
	// Experimental.
...
func (j *jsiiProxy_ContainerRegistry) GarbageCollectionSchedule() ContainerRegistryGarbageCollectionScheduleOutputReference {
	var returns ContainerRegistryGarbageCollectionScheduleOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerRegistry) GarbageCollectionScheduleInput() *ContainerRegistryGarbageCollectionSchedule {
...
func (j *jsiiProxy_ContainerRegistry) Hostname() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostname",
...
func (j *jsiiProxy_ContainerRegistry) StorageUsage() ContainerRegistryStorageUsageList {
	var returns ContainerRegistryStorageUsageList
	_jsii_.Get(
		j,
		"storageUsage",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.13/docs/resources/container_registry ionoscloud_container_registry} Resource.
...
func (c *jsiiProxy_ContainerRegistry) ResetGarbageCollectionSchedule() {
	_jsii_.InvokeVoid(
		c,
		"resetGarbageCollectionSchedule",
		nil, // no parameters
