...
func (j *jsiiProxy_ContainerRegistryTimeoutsOutputReference) Default() *string {
	var returns *string
	_jsii_.Get(
		j,
		"default",
...
func (j *jsiiProxy_ContainerRegistryTimeoutsOutputReference) DefaultInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"defaultInput",
...
func (j *jsiiProxy_ContainerRegistryTimeoutsOutputReference)SetDefault(val *string) {
...
func (c *jsiiProxy_ContainerRegistryTimeoutsOutputReference) ResetDefault() {
	_jsii_.InvokeVoid(
		c,
		"resetDefault",
		nil, // no parameters
