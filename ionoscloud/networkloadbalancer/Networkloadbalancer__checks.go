...
func (n *jsiiProxy_Networkloadbalancer) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (n *jsiiProxy_Networkloadbalancer) validateImportFromParameters(id *string) error {
	if id == nil {
...
func validateNetworkloadbalancer_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func validateNetworkloadbalancer_IsTerraformElementParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func validateNetworkloadbalancer_IsTerraformResourceParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func (j *jsiiProxy_Networkloadbalancer) validateSetCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
