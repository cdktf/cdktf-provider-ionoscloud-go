...
import (
	...
	"github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12/s3bucket/internal"
...
func (j *jsiiProxy_S3Bucket) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_S3Bucket) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.18/docs/resources/s3_bucket ionoscloud_s3_bucket} Resource.
func NewS3Bucket(scope constructs.Construct, id *string, config *S3BucketConfig) S3Bucket {
	...
	_jsii_.Create(
		"@cdktf/provider-ionoscloud.s3Bucket.S3Bucket",
...
func (j *jsiiProxy_S3Bucket)SetName(val *string) {
