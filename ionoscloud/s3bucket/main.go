...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.s3Bucket.S3BucketConfig",
		reflect.TypeOf((*S3BucketConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.s3Bucket.S3BucketTimeouts",
		reflect.TypeOf((*S3BucketTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.s3Bucket.S3BucketTimeoutsOutputReference",
