...
func (d *jsiiProxy_DataIonoscloudVcpuServerNicsFirewallRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataIonoscloudVcpuServerNicsFirewallRulesList) Resolve(context cdktf.IResolveContext) interface{} {
