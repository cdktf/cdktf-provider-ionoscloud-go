...
func (j *jsiiProxy_DataIonoscloudVcpuServerVolumesOutputReference) ExposeSerial() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"exposeSerial",
...
func (d *jsiiProxy_DataIonoscloudVcpuServerVolumesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataIonoscloudVcpuServerVolumesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
