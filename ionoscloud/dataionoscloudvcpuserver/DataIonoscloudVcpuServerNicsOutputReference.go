...
func (d *jsiiProxy_DataIonoscloudVcpuServerNicsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataIonoscloudVcpuServerNicsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
