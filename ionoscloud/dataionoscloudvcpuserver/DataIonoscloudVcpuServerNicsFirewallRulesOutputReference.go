...
func (d *jsiiProxy_DataIonoscloudVcpuServerNicsFirewallRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataIonoscloudVcpuServerNicsFirewallRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
