...
func (d *jsiiProxy_DataIonoscloudVcpuServerVolumesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataIonoscloudVcpuServerVolumesList) Resolve(context cdktf.IResolveContext) interface{} {
