...
func (d *jsiiProxy_DataIonoscloudVcpuServerLabelsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataIonoscloudVcpuServerLabelsList) Resolve(context cdktf.IResolveContext) interface{} {
