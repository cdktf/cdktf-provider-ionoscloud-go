...
type Loadbalancer interface {
	...
	PutTimeouts(value *LoadbalancerTimeouts)
	ResetDhcp()
	ResetId()
	ResetIp()
...
func (j *jsiiProxy_Loadbalancer) DatacenterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datacenterId",
...
func (j *jsiiProxy_Loadbalancer) DatacenterIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datacenterIdInput",
...
func (j *jsiiProxy_Loadbalancer) Dhcp() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dhcp",
...
func (j *jsiiProxy_Loadbalancer) DhcpInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dhcpInput",
...
func (j *jsiiProxy_Loadbalancer) IpInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipInput",
...
func (j *jsiiProxy_Loadbalancer) NicIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"nicIds",
...
func (j *jsiiProxy_Loadbalancer) NicIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"nicIdsInput",
...
func (j *jsiiProxy_Loadbalancer) Timeouts() LoadbalancerTimeoutsOutputReference {
	var returns LoadbalancerTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_Loadbalancer) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func NewLoadbalancer(scope constructs.Construct, id *string, config *LoadbalancerConfig) Loadbalancer {
	...
	_jsii_.Create(
		"@cdktf/provider-ionoscloud.loadbalancer.Loadbalancer",
...
func (j *jsiiProxy_Loadbalancer)SetDatacenterId(val *string) {
...
func (j *jsiiProxy_Loadbalancer)SetDhcp(val interface{}) {
...
func (j *jsiiProxy_Loadbalancer)SetIp(val *string) {
...
func (j *jsiiProxy_Loadbalancer)SetNicIds(val *[]*string) {
	if err := j.validateSetNicIdsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (l *jsiiProxy_Loadbalancer) PutTimeouts(value *LoadbalancerTimeouts) {
...
func (l *jsiiProxy_Loadbalancer) ResetDhcp() {
	_jsii_.InvokeVoid(
		l,
		"resetDhcp",
		nil, // no parameters
...
func (l *jsiiProxy_Loadbalancer) ResetIp() {
	_jsii_.InvokeVoid(
		l,
		"resetIp",
		nil, // no parameters
...
func (l *jsiiProxy_Loadbalancer) ResetTimeouts() {
	_jsii_.InvokeVoid(
		l,
		"resetTimeouts",
		nil, // no parameters
