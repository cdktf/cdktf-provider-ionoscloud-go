...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.dataIonoscloudResource.DataIonoscloudResourceConfig",
		reflect.TypeOf((*DataIonoscloudResourceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.dataIonoscloudResource.DataIonoscloudResourceTimeouts",
