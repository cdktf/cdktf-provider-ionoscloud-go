...
func (j *jsiiProxy_DataIonoscloudMongoCluster) Credentials() DataIonoscloudMongoClusterCredentialsList {
	var returns DataIonoscloudMongoClusterCredentialsList
	_jsii_.Get(
		j,
		"credentials",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.4.2/docs/data-sources/mongo_cluster ionoscloud_mongo_cluster} Data Source.
