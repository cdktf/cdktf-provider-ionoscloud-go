...
func (d *jsiiProxy_DataIonoscloudAutoscalingGroupReplicaConfigurationVolumeOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataIonoscloudAutoscalingGroupReplicaConfigurationVolumeOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
