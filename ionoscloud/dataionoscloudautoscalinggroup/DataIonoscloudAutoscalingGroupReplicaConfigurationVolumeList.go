...
func (d *jsiiProxy_DataIonoscloudAutoscalingGroupReplicaConfigurationVolumeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataIonoscloudAutoscalingGroupReplicaConfigurationVolumeList) Resolve(context cdktf.IResolveContext) interface{} {
