...
func (t *jsiiProxy_TargetGroup) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (t *jsiiProxy_TargetGroup) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (t *jsiiProxy_TargetGroup) validatePutTargetsParameters(value interface{}) error {
	...
	case *[]*TargetGroupTargets:
		value := value.(*[]*TargetGroupTargets)
	...
	case []*TargetGroupTargets:
		value_ := value.([]*TargetGroupTargets)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*TargetGroupTargets; received %#v (a %T)", value, value)
		}
	}
