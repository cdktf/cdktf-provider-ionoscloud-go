...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.targetGroup.TargetGroupConfig",
		reflect.TypeOf((*TargetGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.targetGroup.TargetGroupHealthCheck",
		reflect.TypeOf((*TargetGroupHealthCheck)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.targetGroup.TargetGroupHealthCheckOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.targetGroup.TargetGroupHttpHealthCheck",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.targetGroup.TargetGroupTargets",
		reflect.TypeOf((*TargetGroupTargets)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.targetGroup.TargetGroupTargetsList",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.targetGroup.TargetGroupTimeouts",
