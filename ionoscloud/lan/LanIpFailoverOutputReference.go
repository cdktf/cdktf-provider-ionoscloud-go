...
type LanIpFailoverOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for LanIpFailoverOutputReference
type jsiiProxy_LanIpFailoverOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_LanIpFailoverOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_LanIpFailoverOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LanIpFailoverOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_LanIpFailoverOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LanIpFailoverOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LanIpFailoverOutputReference) Ip() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ip",
...
func (j *jsiiProxy_LanIpFailoverOutputReference) NicUuid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nicUuid",
...
func (j *jsiiProxy_LanIpFailoverOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_LanIpFailoverOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewLanIpFailoverOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LanIpFailoverOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-ionoscloud.lan.LanIpFailoverOutputReference",
...
func NewLanIpFailoverOutputReference_Override(l LanIpFailoverOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (l *jsiiProxy_LanIpFailoverOutputReference) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LanIpFailoverOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (l *jsiiProxy_LanIpFailoverOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LanIpFailoverOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (l *jsiiProxy_LanIpFailoverOutputReference) ToString() *string {
	var returns *string
