...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.ipfailover.IpfailoverConfig",
		reflect.TypeOf((*IpfailoverConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.ipfailover.IpfailoverTimeouts",
		reflect.TypeOf((*IpfailoverTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.ipfailover.IpfailoverTimeoutsOutputReference",
