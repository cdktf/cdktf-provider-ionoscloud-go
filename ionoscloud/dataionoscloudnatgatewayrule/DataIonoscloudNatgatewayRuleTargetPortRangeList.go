...
func NewDataIonoscloudNatgatewayRuleTargetPortRangeList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataIonoscloudNatgatewayRuleTargetPortRangeList {
	...
	if err := validateNewDataIonoscloudNatgatewayRuleTargetPortRangeListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataIonoscloudNatgatewayRuleTargetPortRangeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataIonoscloudNatgatewayRuleTargetPortRangeList) Resolve(context cdktf.IResolveContext) interface{} {
