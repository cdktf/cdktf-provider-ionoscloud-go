...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nodeSubnetInput", GoGetter: "NodeSubnetInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNodeSubnet", GoMethod: "ResetNodeSubnet"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.k8SCluster.K8SClusterConfig",
		reflect.TypeOf((*K8SClusterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.k8SCluster.K8SClusterMaintenanceWindow",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.k8SCluster.K8SClusterS3Buckets",
		reflect.TypeOf((*K8SClusterS3Buckets)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.k8SCluster.K8SClusterS3BucketsList",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.k8SCluster.K8SClusterTimeouts",
