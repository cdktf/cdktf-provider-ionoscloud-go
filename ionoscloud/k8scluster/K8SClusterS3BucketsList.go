...
type K8SClusterS3BucketsList interface {
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) K8SClusterS3BucketsOutputReference
...
// The jsii proxy struct for K8SClusterS3BucketsList
type jsiiProxy_K8SClusterS3BucketsList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_K8SClusterS3BucketsList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_K8SClusterS3BucketsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_K8SClusterS3BucketsList) InternalValue() interface{} {
...
func (j *jsiiProxy_K8SClusterS3BucketsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_K8SClusterS3BucketsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_K8SClusterS3BucketsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (k *jsiiProxy_K8SClusterS3BucketsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (k *jsiiProxy_K8SClusterS3BucketsList) ComputeFqn() *string {
	var returns *string
...
func (k *jsiiProxy_K8SClusterS3BucketsList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (k *jsiiProxy_K8SClusterS3BucketsList) ToString() *string {
	var returns *string
