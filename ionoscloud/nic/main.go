...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.nic.NicConfig",
		reflect.TypeOf((*NicConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.nic.NicFlowlog",
		reflect.TypeOf((*NicFlowlog)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.nic.NicFlowlogOutputReference",
		reflect.TypeOf((*NicFlowlogOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.nic.NicTimeouts",
