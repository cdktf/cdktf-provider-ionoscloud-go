...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpnWireguardPeer)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.vpnWireguardPeer.VpnWireguardPeerConfig",
		reflect.TypeOf((*VpnWireguardPeerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.vpnWireguardPeer.VpnWireguardPeerEndpoint",
		reflect.TypeOf((*VpnWireguardPeerEndpoint)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.vpnWireguardPeer.VpnWireguardPeerEndpointOutputReference",
		reflect.TypeOf((*VpnWireguardPeerEndpointOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.vpnWireguardPeer.VpnWireguardPeerTimeouts",
		reflect.TypeOf((*VpnWireguardPeerTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.vpnWireguardPeer.VpnWireguardPeerTimeoutsOutputReference",
		reflect.TypeOf((*VpnWireguardPeerTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
