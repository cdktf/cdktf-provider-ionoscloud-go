...
import (
	...
	"github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12/s3bucketpolicy/internal"
...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.18/docs/resources/s3_bucket_policy ionoscloud_s3_bucket_policy} Resource.
func NewS3BucketPolicy(scope constructs.Construct, id *string, config *S3BucketPolicyConfig) S3BucketPolicy {
	...
	_jsii_.Create(
		"@cdktf/provider-ionoscloud.s3BucketPolicy.S3BucketPolicy",
