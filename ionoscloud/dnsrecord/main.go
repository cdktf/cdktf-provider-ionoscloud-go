...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.dnsRecord.DnsRecordConfig",
		reflect.TypeOf((*DnsRecordConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.dnsRecord.DnsRecordTimeouts",
		reflect.TypeOf((*DnsRecordTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.dnsRecord.DnsRecordTimeoutsOutputReference",
		reflect.TypeOf((*DnsRecordTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
