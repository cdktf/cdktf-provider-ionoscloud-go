...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.nsg.NsgConfig",
		reflect.TypeOf((*NsgConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.nsg.NsgTimeouts",
		reflect.TypeOf((*NsgTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.nsg.NsgTimeoutsOutputReference",
		reflect.TypeOf((*NsgTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
