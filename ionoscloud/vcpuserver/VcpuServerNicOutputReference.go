...
func (j *jsiiProxy_VcpuServerNicOutputReference) MacInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"macInput",
...
func (j *jsiiProxy_VcpuServerNicOutputReference)SetMac(val *string) {
...
func (v *jsiiProxy_VcpuServerNicOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VcpuServerNicOutputReference) ResetMac() {
	_jsii_.InvokeVoid(
		v,
		"resetMac",
		nil, // no parameters
...
func (v *jsiiProxy_VcpuServerNicOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
