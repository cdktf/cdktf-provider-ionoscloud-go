...
func (v *jsiiProxy_VcpuServerNicFirewallList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VcpuServerNicFirewallList) Resolve(context cdktf.IResolveContext) interface{} {
