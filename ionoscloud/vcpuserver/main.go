...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nicMultiQueueInput", GoGetter: "NicMultiQueueInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNicMultiQueue", GoMethod: "ResetNicMultiQueue"},
