...
func (v *jsiiProxy_VcpuServerNicFirewallList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (v *jsiiProxy_VcpuServerNicFirewallList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
