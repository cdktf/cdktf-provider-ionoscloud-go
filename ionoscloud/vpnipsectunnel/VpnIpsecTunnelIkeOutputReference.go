...
func (v *jsiiProxy_VpnIpsecTunnelIkeOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnIpsecTunnelIkeOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
