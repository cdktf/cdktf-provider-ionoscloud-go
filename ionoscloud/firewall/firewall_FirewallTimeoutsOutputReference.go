...
import (
	...
	"github.com/hashicorp/cdktf-provider-ionoscloud-go/ionoscloud/v3/firewall/internal"
...
func (j *jsiiProxy_FirewallTimeoutsOutputReference) Default() *string {
	var returns *string
	_jsii_.Get(
		j,
		"default",
...
func (j *jsiiProxy_FirewallTimeoutsOutputReference) DefaultInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"defaultInput",
...
func NewFirewallTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FirewallTimeoutsOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-ionoscloud.firewall.FirewallTimeoutsOutputReference",
...
func (j *jsiiProxy_FirewallTimeoutsOutputReference)SetDefault(val *string) {
...
func (f *jsiiProxy_FirewallTimeoutsOutputReference) ResetDefault() {
	_jsii_.InvokeVoid(
		f,
		"resetDefault",
		nil, // no parameters
