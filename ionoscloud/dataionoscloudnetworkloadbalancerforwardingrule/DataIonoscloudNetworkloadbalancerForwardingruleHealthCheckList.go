...
func (d *jsiiProxy_DataIonoscloudNetworkloadbalancerForwardingruleHealthCheckList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataIonoscloudNetworkloadbalancerForwardingruleHealthCheckList) Resolve(context cdktf.IResolveContext) interface{} {
