...
func (d *jsiiProxy_DataIonoscloudPrivateCrossconnectConnectableDatacentersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataIonoscloudPrivateCrossconnectConnectableDatacentersList) Resolve(context cdktf.IResolveContext) interface{} {
