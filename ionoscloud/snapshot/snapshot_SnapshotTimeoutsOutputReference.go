...
func (j *jsiiProxy_SnapshotTimeoutsOutputReference) Default() *string {
	var returns *string
	_jsii_.Get(
		j,
		"default",
...
func (j *jsiiProxy_SnapshotTimeoutsOutputReference) DefaultInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"defaultInput",
...
func (j *jsiiProxy_SnapshotTimeoutsOutputReference)SetDefault(val *string) {
...
func (s *jsiiProxy_SnapshotTimeoutsOutputReference) ResetDefault() {
	_jsii_.InvokeVoid(
		s,
		"resetDefault",
		nil, // no parameters
