...
import (
	...
	"github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12/snapshot/internal"
...
func (j *jsiiProxy_Snapshot) CpuHotUnplug() cdktf.IResolvable {
...
func (j *jsiiProxy_Snapshot) DatacenterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datacenterId",
...
func (j *jsiiProxy_Snapshot) DatacenterIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datacenterIdInput",
...
func (j *jsiiProxy_Snapshot) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_Snapshot) DiscScsiHotUnplug() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"discScsiHotUnplug",
...
func (j *jsiiProxy_Snapshot) LicenceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"licenceType",
...
func (j *jsiiProxy_Snapshot) RamHotUnplug() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"ramHotUnplug",
...
func (j *jsiiProxy_Snapshot) Size() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"size",
...
func (j *jsiiProxy_Snapshot) VolumeId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"volumeId",
...
func (j *jsiiProxy_Snapshot) VolumeIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"volumeIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.15/docs/resources/snapshot ionoscloud_snapshot} Resource.
...
func (j *jsiiProxy_Snapshot)SetVolumeId(val *string) {
