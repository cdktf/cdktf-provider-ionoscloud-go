...
type S3BucketServerSideEncryptionConfigurationRuleOutputReference interface {
	...
	ApplyServerSideEncryptionByDefaultInput() interface{}
...
func (j *jsiiProxy_S3BucketServerSideEncryptionConfigurationRuleOutputReference) ApplyServerSideEncryptionByDefaultInput() interface{} {
...
func (j *jsiiProxy_S3BucketServerSideEncryptionConfigurationRuleOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewS3BucketServerSideEncryptionConfigurationRuleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) S3BucketServerSideEncryptionConfigurationRuleOutputReference {
	_init_.Initialize()

	if err := validateNewS3BucketServerSideEncryptionConfigurationRuleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_S3BucketServerSideEncryptionConfigurationRuleOutputReference{}

	_jsii_.Create(
		"@cdktf/provider-ionoscloud.s3BucketServerSideEncryptionConfiguration.S3BucketServerSideEncryptionConfigurationRuleOutputReference",
...
func NewS3BucketServerSideEncryptionConfigurationRuleOutputReference_Override(s S3BucketServerSideEncryptionConfigurationRuleOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3BucketServerSideEncryptionConfigurationRuleOutputReference)SetInternalValue(val interface{}) {
