...
// The jsii proxy struct for DataIonoscloudServers
type jsiiProxy_DataIonoscloudServers struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataIonoscloudServers) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataIonoscloudServers) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_DataIonoscloudServers) Count() interface{} {
...
func (j *jsiiProxy_DataIonoscloudServers) DatacenterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datacenterId",
...
func (j *jsiiProxy_DataIonoscloudServers) DatacenterIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datacenterIdInput",
...
func (j *jsiiProxy_DataIonoscloudServers) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataIonoscloudServers) Filter() DataIonoscloudServersFilterList {
	var returns DataIonoscloudServersFilterList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataIonoscloudServers) FilterInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"filterInput",
...
func (j *jsiiProxy_DataIonoscloudServers) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataIonoscloudServers) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataIonoscloudServers) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataIonoscloudServers) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataIonoscloudServers) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataIonoscloudServers) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataIonoscloudServers) Node() constructs.Node {
...
func (j *jsiiProxy_DataIonoscloudServers) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataIonoscloudServers) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_DataIonoscloudServers) Servers() DataIonoscloudServersServersList {
	var returns DataIonoscloudServersServersList
	_jsii_.Get(
		j,
		"servers",
		&returns,
...
func (j *jsiiProxy_DataIonoscloudServers) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataIonoscloudServers) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataIonoscloudServers) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataIonoscloudServers) Timeouts() DataIonoscloudServersTimeoutsOutputReference {
	var returns DataIonoscloudServersTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_DataIonoscloudServers) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.12/docs/data-sources/servers ionoscloud_servers} Data Source.
...
func (j *jsiiProxy_DataIonoscloudServers)SetCount(val interface{}) {
...
func DataIonoscloudServers_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateDataIonoscloudServers_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataIonoscloudServers_IsTerraformDataSource(x interface{}) *bool {
	...
	if err := validateDataIonoscloudServers_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DataIonoscloudServers_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateDataIonoscloudServers_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataIonoscloudServers) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataIonoscloudServers) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataIonoscloudServers) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
...
func (d *jsiiProxy_DataIonoscloudServers) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataIonoscloudServers) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataIonoscloudServers) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataIonoscloudServers) ToMetadata() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataIonoscloudServers) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataIonoscloudServers) ToTerraform() interface{} {
	var returns interface{}
