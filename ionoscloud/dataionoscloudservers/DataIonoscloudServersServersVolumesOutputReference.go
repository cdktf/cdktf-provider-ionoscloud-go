...
func (j *jsiiProxy_DataIonoscloudServersServersVolumesOutputReference) ExposeSerial() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"exposeSerial",
...
func (d *jsiiProxy_DataIonoscloudServersServersVolumesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataIonoscloudServersServersVolumesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
