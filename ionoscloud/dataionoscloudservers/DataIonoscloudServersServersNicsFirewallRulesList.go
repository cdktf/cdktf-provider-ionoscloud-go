...
func (d *jsiiProxy_DataIonoscloudServersServersNicsFirewallRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataIonoscloudServersServersNicsFirewallRulesList) Resolve(context cdktf.IResolveContext) interface{} {
