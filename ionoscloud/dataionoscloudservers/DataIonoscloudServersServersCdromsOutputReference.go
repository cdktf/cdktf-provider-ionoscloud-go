...
func (d *jsiiProxy_DataIonoscloudServersServersCdromsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataIonoscloudServersServersCdromsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
