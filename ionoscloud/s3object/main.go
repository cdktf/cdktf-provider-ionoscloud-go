...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "objectLockLegalHoldInput", GoGetter: "ObjectLockLegalHoldInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetObjectLockLegalHold", GoMethod: "ResetObjectLockLegalHold"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServerSideEncryptionContext", GoMethod: "ResetServerSideEncryptionContext"},
			_jsii_.MemberMethod{JsiiMethod: "resetServerSideEncryptionCustomerAlgorithm", GoMethod: "ResetServerSideEncryptionCustomerAlgorithm"},
			_jsii_.MemberMethod{JsiiMethod: "resetServerSideEncryptionCustomerKey", GoMethod: "ResetServerSideEncryptionCustomerKey"},
			_jsii_.MemberMethod{JsiiMethod: "resetServerSideEncryptionCustomerKeyMd5", GoMethod: "ResetServerSideEncryptionCustomerKeyMd5"},
			...
			_jsii_.MemberProperty{JsiiProperty: "serverSideEncryptionContextInput", GoGetter: "ServerSideEncryptionContextInput"},
			_jsii_.MemberProperty{JsiiProperty: "serverSideEncryptionCustomerAlgorithm", GoGetter: "ServerSideEncryptionCustomerAlgorithm"},
			_jsii_.MemberProperty{JsiiProperty: "serverSideEncryptionCustomerAlgorithmInput", GoGetter: "ServerSideEncryptionCustomerAlgorithmInput"},
			_jsii_.MemberProperty{JsiiProperty: "serverSideEncryptionCustomerKey", GoGetter: "ServerSideEncryptionCustomerKey"},
			_jsii_.MemberProperty{JsiiProperty: "serverSideEncryptionCustomerKeyInput", GoGetter: "ServerSideEncryptionCustomerKeyInput"},
			_jsii_.MemberProperty{JsiiProperty: "serverSideEncryptionCustomerKeyMd5", GoGetter: "ServerSideEncryptionCustomerKeyMd5"},
			_jsii_.MemberProperty{JsiiProperty: "serverSideEncryptionCustomerKeyMd5Input", GoGetter: "ServerSideEncryptionCustomerKeyMd5Input"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.s3Object.S3ObjectConfig",
