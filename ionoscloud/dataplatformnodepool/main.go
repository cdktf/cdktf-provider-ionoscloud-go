...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataplatformNodePool)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCoresCount", GoMethod: "ResetCoresCount"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRamSize", GoMethod: "ResetRamSize"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.dataplatformNodePool.DataplatformNodePoolAutoScaling",
		reflect.TypeOf((*DataplatformNodePoolAutoScaling)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.dataplatformNodePool.DataplatformNodePoolAutoScalingOutputReference",
		reflect.TypeOf((*DataplatformNodePoolAutoScalingOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.dataplatformNodePool.DataplatformNodePoolConfig",
		reflect.TypeOf((*DataplatformNodePoolConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.dataplatformNodePool.DataplatformNodePoolMaintenanceWindow",
		reflect.TypeOf((*DataplatformNodePoolMaintenanceWindow)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.dataplatformNodePool.DataplatformNodePoolMaintenanceWindowList",
		reflect.TypeOf((*DataplatformNodePoolMaintenanceWindowList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataplatformNodePoolMaintenanceWindowOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.dataplatformNodePool.DataplatformNodePoolTimeouts",
		reflect.TypeOf((*DataplatformNodePoolTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.dataplatformNodePool.DataplatformNodePoolTimeoutsOutputReference",
		reflect.TypeOf((*DataplatformNodePoolTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
