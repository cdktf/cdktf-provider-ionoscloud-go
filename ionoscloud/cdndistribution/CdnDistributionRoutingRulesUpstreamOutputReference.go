...
func (c *jsiiProxy_CdnDistributionRoutingRulesUpstreamOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnDistributionRoutingRulesUpstreamOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
