...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetS3AccessKey", GoMethod: "ResetS3AccessKey"},
			_jsii_.MemberMethod{JsiiMethod: "resetS3Region", GoMethod: "ResetS3Region"},
			_jsii_.MemberMethod{JsiiMethod: "resetS3SecretKey", GoMethod: "ResetS3SecretKey"},
			...
			_jsii_.MemberProperty{JsiiProperty: "s3AccessKey", GoGetter: "S3AccessKey"},
			_jsii_.MemberProperty{JsiiProperty: "s3AccessKeyInput", GoGetter: "S3AccessKeyInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "s3SecretKey", GoGetter: "S3SecretKey"},
			_jsii_.MemberProperty{JsiiProperty: "s3SecretKeyInput", GoGetter: "S3SecretKeyInput"},
