...
func (d *jsiiProxy_DataIonoscloudCubeServerCdromsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataIonoscloudCubeServerCdromsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
