...
func (d *jsiiProxy_DataIonoscloudCubeServerVolumesOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataIonoscloudCubeServerVolumesOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
