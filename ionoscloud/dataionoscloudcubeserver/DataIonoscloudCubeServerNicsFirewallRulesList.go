...
func (d *jsiiProxy_DataIonoscloudCubeServerNicsFirewallRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataIonoscloudCubeServerNicsFirewallRulesList) Resolve(context cdktf.IResolveContext) interface{} {
