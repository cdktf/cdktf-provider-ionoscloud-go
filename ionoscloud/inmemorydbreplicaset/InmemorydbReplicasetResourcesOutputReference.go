...
func (i *jsiiProxy_InmemorydbReplicasetResourcesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_InmemorydbReplicasetResourcesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
