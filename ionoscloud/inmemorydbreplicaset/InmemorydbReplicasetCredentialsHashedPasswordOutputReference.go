...
func (i *jsiiProxy_InmemorydbReplicasetCredentialsHashedPasswordOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_InmemorydbReplicasetCredentialsHashedPasswordOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
