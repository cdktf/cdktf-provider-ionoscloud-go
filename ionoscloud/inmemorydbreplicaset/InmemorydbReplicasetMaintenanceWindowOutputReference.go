...
func (i *jsiiProxy_InmemorydbReplicasetMaintenanceWindowOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (i *jsiiProxy_InmemorydbReplicasetMaintenanceWindowOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
