...
type Certificate interface {
	...
	PutTimeouts(value *CertificateTimeouts)
...
func (j *jsiiProxy_Certificate) Certificate() *string {
	var returns *string
	_jsii_.Get(
		j,
		"certificate",
...
func (j *jsiiProxy_Certificate) CertificateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"certificateInput",
...
func (j *jsiiProxy_Certificate) Timeouts() CertificateTimeoutsOutputReference {
	var returns CertificateTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_Certificate) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.4.18/docs/resources/certificate ionoscloud_certificate} Resource.
func NewCertificate(scope constructs.Construct, id *string, config *CertificateConfig) Certificate {
	...
	_jsii_.Create(
		"@cdktf/provider-ionoscloud.certificate.Certificate",
...
func (j *jsiiProxy_Certificate)SetCertificate(val *string) {
...
func (c *jsiiProxy_Certificate) PutTimeouts(value *CertificateTimeouts) {
...
func (c *jsiiProxy_Certificate) ResetTimeouts() {
	_jsii_.InvokeVoid(
		c,
		"resetTimeouts",
		nil, // no parameters
