...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.certificate.CertificateConfig",
		reflect.TypeOf((*CertificateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.certificate.CertificateTimeouts",
		reflect.TypeOf((*CertificateTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.certificate.CertificateTimeoutsOutputReference",
		reflect.TypeOf((*CertificateTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
