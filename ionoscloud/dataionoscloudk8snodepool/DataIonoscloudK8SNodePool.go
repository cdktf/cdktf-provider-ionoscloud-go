...
func (j *jsiiProxy_DataIonoscloudK8SNodePool) ServerType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serverType",
...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.18/docs/data-sources/k8s_node_pool ionoscloud_k8s_node_pool} Data Source.
