...
import (
	...
	"github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12/s3bucketcorsconfiguration/internal"
...
func (j *jsiiProxy_S3BucketCorsConfigurationCorsRuleOutputReference) Id() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_S3BucketCorsConfigurationCorsRuleOutputReference) IdInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"idInput",
...
func NewS3BucketCorsConfigurationCorsRuleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) S3BucketCorsConfigurationCorsRuleOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-ionoscloud.s3BucketCorsConfiguration.S3BucketCorsConfigurationCorsRuleOutputReference",
...
func (j *jsiiProxy_S3BucketCorsConfigurationCorsRuleOutputReference)SetId(val *float64) {
