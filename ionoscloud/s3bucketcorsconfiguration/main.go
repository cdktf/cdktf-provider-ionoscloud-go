...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.s3BucketCorsConfiguration.S3BucketCorsConfiguration",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.s3BucketCorsConfiguration.S3BucketCorsConfigurationConfig",
		reflect.TypeOf((*S3BucketCorsConfigurationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.s3BucketCorsConfiguration.S3BucketCorsConfigurationCorsRule",
		reflect.TypeOf((*S3BucketCorsConfigurationCorsRule)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.s3BucketCorsConfiguration.S3BucketCorsConfigurationCorsRuleList",
