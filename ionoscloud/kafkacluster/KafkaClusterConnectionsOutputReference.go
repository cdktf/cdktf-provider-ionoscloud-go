...
func (k *jsiiProxy_KafkaClusterConnectionsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KafkaClusterConnectionsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
