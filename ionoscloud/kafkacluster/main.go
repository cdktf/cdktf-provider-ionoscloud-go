...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KafkaCluster)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.kafkaCluster.KafkaClusterConfig",
		reflect.TypeOf((*KafkaClusterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.kafkaCluster.KafkaClusterConnections",
		reflect.TypeOf((*KafkaClusterConnections)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.kafkaCluster.KafkaClusterConnectionsOutputReference",
		reflect.TypeOf((*KafkaClusterConnectionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "brokerAddresses", GoGetter: "BrokerAddresses"},
			_jsii_.MemberProperty{JsiiProperty: "brokerAddressesInput", GoGetter: "BrokerAddressesInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.kafkaCluster.KafkaClusterTimeouts",
		reflect.TypeOf((*KafkaClusterTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.kafkaCluster.KafkaClusterTimeoutsOutputReference",
		reflect.TypeOf((*KafkaClusterTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
