...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataIonoscloudCertificate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.dataIonoscloudCertificate.DataIonoscloudCertificateConfig",
		reflect.TypeOf((*DataIonoscloudCertificateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.dataIonoscloudCertificate.DataIonoscloudCertificateTimeouts",
		reflect.TypeOf((*DataIonoscloudCertificateTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.dataIonoscloudCertificate.DataIonoscloudCertificateTimeoutsOutputReference",
		reflect.TypeOf((*DataIonoscloudCertificateTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
