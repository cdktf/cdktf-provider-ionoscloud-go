...
func (k *jsiiProxy_K8SNodePoolMaintenanceWindowOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_K8SNodePoolMaintenanceWindowOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
