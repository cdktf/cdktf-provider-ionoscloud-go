...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.k8SNodePool.K8SNodePoolAutoScaling",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.k8SNodePool.K8SNodePoolConfig",
		reflect.TypeOf((*K8SNodePoolConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.k8SNodePool.K8SNodePoolLans",
		reflect.TypeOf((*K8SNodePoolLans)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.k8SNodePool.K8SNodePoolLansList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.k8SNodePool.K8SNodePoolLansOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.k8SNodePool.K8SNodePoolLansRoutes",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.k8SNodePool.K8SNodePoolMaintenanceWindow",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.k8SNodePool.K8SNodePoolTimeouts",
