...
func (k *jsiiProxy_K8SNodePoolLansRoutesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (k *jsiiProxy_K8SNodePoolLansRoutesList) Resolve(context cdktf.IResolveContext) interface{} {
