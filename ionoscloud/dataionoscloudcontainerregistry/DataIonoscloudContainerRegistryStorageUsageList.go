...
func (d *jsiiProxy_DataIonoscloudContainerRegistryStorageUsageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataIonoscloudContainerRegistryStorageUsageList) Resolve(context cdktf.IResolveContext) interface{} {
