...
func (j *jsiiProxy_DataIonoscloudContainerRegistry) ApiSubnetAllowList() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"apiSubnetAllowList",
...
func (j *jsiiProxy_DataIonoscloudContainerRegistry) Features() DataIonoscloudContainerRegistryFeaturesList {
	var returns DataIonoscloudContainerRegistryFeaturesList
	_jsii_.Get(
		j,
		"features",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.14/docs/data-sources/container_registry ionoscloud_container_registry} Data Source.
...
func DataIonoscloudContainerRegistry_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataIonoscloudContainerRegistry_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataIonoscloudContainerRegistry) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataIonoscloudContainerRegistry) ToHclTerraform() interface{} {
	var returns interface{}
