...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.4.17/docs/data-sources/snapshot ionoscloud_snapshot} Data Source.
...
func (d *jsiiProxy_DataIonoscloudSnapshot) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataIonoscloudSnapshot) ToHclTerraform() interface{} {
	var returns interface{}
