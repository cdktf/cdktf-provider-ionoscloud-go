...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.dataIonoscloudNic.DataIonoscloudNicConfig",
		reflect.TypeOf((*DataIonoscloudNicConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.dataIonoscloudNic.DataIonoscloudNicFlowlog",
		reflect.TypeOf((*DataIonoscloudNicFlowlog)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.dataIonoscloudNic.DataIonoscloudNicFlowlogList",
		reflect.TypeOf((*DataIonoscloudNicFlowlogList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataIonoscloudNicFlowlogOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.dataIonoscloudNic.DataIonoscloudNicTimeouts",
