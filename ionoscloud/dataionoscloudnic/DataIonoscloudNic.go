...
func (j *jsiiProxy_DataIonoscloudNic) Flowlog() DataIonoscloudNicFlowlogList {
	var returns DataIonoscloudNicFlowlogList
	_jsii_.Get(
		j,
		"flowlog",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.12/docs/data-sources/nic ionoscloud_nic} Data Source.
...
func DataIonoscloudNic_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataIonoscloudNic_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataIonoscloudNic) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataIonoscloudNic) ToHclTerraform() interface{} {
	var returns interface{}
