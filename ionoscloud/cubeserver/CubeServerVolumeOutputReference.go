...
func (j *jsiiProxy_CubeServerVolumeOutputReference) ExposeSerial() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"exposeSerial",
...
func (j *jsiiProxy_CubeServerVolumeOutputReference) ExposeSerialInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"exposeSerialInput",
...
func (j *jsiiProxy_CubeServerVolumeOutputReference)SetExposeSerial(val interface{}) {
...
func (c *jsiiProxy_CubeServerVolumeOutputReference) ResetExposeSerial() {
	_jsii_.InvokeVoid(
		c,
		"resetExposeSerial",
		nil, // no parameters
