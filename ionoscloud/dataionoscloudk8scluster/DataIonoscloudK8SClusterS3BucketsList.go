...
func NewDataIonoscloudK8SClusterS3BucketsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataIonoscloudK8SClusterS3BucketsList {
	...
	if err := validateNewDataIonoscloudK8SClusterS3BucketsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataIonoscloudK8SClusterS3BucketsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
