...
func (d *jsiiProxy_DataIonoscloudK8SClusterConfigClustersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataIonoscloudK8SClusterConfigClustersList) Resolve(context cdktf.IResolveContext) interface{} {
