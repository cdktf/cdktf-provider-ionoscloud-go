...
func NewDataIonoscloudK8SClusterConfigAOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataIonoscloudK8SClusterConfigAOutputReference {
	...
	if err := validateNewDataIonoscloudK8SClusterConfigAOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataIonoscloudK8SClusterConfigAOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataIonoscloudK8SClusterConfigAOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
