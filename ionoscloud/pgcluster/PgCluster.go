...
func (j *jsiiProxy_PgCluster) DnsName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dnsName",
...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.12/docs/resources/pg_cluster ionoscloud_pg_cluster} Resource.
...
func PgCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validatePgCluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func PgCluster_IsTerraformElement(x interface{}) *bool {
	...
	if err := validatePgCluster_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func PgCluster_IsTerraformResource(x interface{}) *bool {
	...
	if err := validatePgCluster_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_PgCluster) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PgCluster) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PgCluster) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PgCluster) MoveFromId(id *string) {
...
func (p *jsiiProxy_PgCluster) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PgCluster) MoveToId(id *string) {
...
func (p *jsiiProxy_PgCluster) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PgCluster) ToHclTerraform() interface{} {
	var returns interface{}
