...
func (j *jsiiProxy_S3BucketObjectLockConfigurationRuleOutputReference) DefaultRetentionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationRuleOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewS3BucketObjectLockConfigurationRuleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3BucketObjectLockConfigurationRuleOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-ionoscloud.s3BucketObjectLockConfiguration.S3BucketObjectLockConfigurationRuleOutputReference",
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationRuleOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_S3BucketObjectLockConfigurationRuleOutputReference) ResetDefaultRetention() {
	_jsii_.InvokeVoid(
		s,
		"resetDefaultRetention",
		nil, // no parameters
