...
func (j *jsiiProxy_S3BucketObjectLockConfigurationRuleDefaultRetentionOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewS3BucketObjectLockConfigurationRuleDefaultRetentionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3BucketObjectLockConfigurationRuleDefaultRetentionOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-ionoscloud.s3BucketObjectLockConfiguration.S3BucketObjectLockConfigurationRuleDefaultRetentionOutputReference",
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationRuleDefaultRetentionOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_S3BucketObjectLockConfigurationRuleDefaultRetentionOutputReference) ResetMode() {
	_jsii_.InvokeVoid(
		s,
		"resetMode",
		nil, // no parameters
