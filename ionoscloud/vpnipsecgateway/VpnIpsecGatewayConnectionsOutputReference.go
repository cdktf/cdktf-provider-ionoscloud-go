...
func (v *jsiiProxy_VpnIpsecGatewayConnectionsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnIpsecGatewayConnectionsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
