...
func (n *jsiiProxy_NetworkloadbalancerForwardingruleHealthCheckOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkloadbalancerForwardingruleHealthCheckOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
