...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.4.16/docs/resources/networkloadbalancer_forwardingrule ionoscloud_networkloadbalancer_forwardingrule} Resource.
...
func NetworkloadbalancerForwardingrule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateNetworkloadbalancerForwardingrule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NetworkloadbalancerForwardingrule) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetworkloadbalancerForwardingrule) HasResourceMove() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NetworkloadbalancerForwardingrule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (n *jsiiProxy_NetworkloadbalancerForwardingrule) MoveFromId(id *string) {
...
func (n *jsiiProxy_NetworkloadbalancerForwardingrule) MoveTo(moveTarget *string, index interface{}) {
...
func (n *jsiiProxy_NetworkloadbalancerForwardingrule) MoveToId(id *string) {
...
func (n *jsiiProxy_NetworkloadbalancerForwardingrule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NetworkloadbalancerForwardingrule) ToHclTerraform() interface{} {
	var returns interface{}
