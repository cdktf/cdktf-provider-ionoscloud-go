...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AutoCertificate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.autoCertificate.AutoCertificateConfig",
		reflect.TypeOf((*AutoCertificateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.autoCertificate.AutoCertificateTimeouts",
		reflect.TypeOf((*AutoCertificateTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.autoCertificate.AutoCertificateTimeoutsOutputReference",
		reflect.TypeOf((*AutoCertificateTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
