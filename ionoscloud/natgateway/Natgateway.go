...
func (j *jsiiProxy_Natgateway) DatacenterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datacenterId",
...
func (j *jsiiProxy_Natgateway) DatacenterIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datacenterIdInput",
...
func (j *jsiiProxy_Natgateway) Lans() NatgatewayLansList {
	var returns NatgatewayLansList
	_jsii_.Get(
		j,
		"lans",
		&returns,
...
func (j *jsiiProxy_Natgateway) LansInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"lansInput",
...
func (j *jsiiProxy_Natgateway) PublicIps() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"publicIps",
...
func (j *jsiiProxy_Natgateway) PublicIpsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"publicIpsInput",
...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.4.18/docs/resources/natgateway ionoscloud_natgateway} Resource.
...
func (j *jsiiProxy_Natgateway)SetDatacenterId(val *string) {
...
func (j *jsiiProxy_Natgateway)SetPublicIps(val *[]*string) {
...
func (n *jsiiProxy_Natgateway) PutLans(value interface{}) {
	if err := n.validatePutLansParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		n,
