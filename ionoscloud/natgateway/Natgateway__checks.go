...
func (n *jsiiProxy_Natgateway) validatePutLansParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*NatgatewayLans; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_Natgateway) validateSetDatacenterIdParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_Natgateway) validateSetPublicIpsParameters(val *[]*string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
