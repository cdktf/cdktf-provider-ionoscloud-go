...
func (n *jsiiProxy_NatgatewayRuleTargetPortRangeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NatgatewayRuleTargetPortRangeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
