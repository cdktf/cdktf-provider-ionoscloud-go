...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVersioningConfiguration", GoMethod: "ResetVersioningConfiguration"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.s3BucketVersioning.S3BucketVersioningConfig",
		reflect.TypeOf((*S3BucketVersioningConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.s3BucketVersioning.S3BucketVersioningVersioningConfiguration",
