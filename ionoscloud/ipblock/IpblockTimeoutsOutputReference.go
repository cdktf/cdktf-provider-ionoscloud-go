...
func (i *jsiiProxy_IpblockTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IpblockTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
