...
func (a *jsiiProxy_AutoscalingGroup) validatePutPolicyParameters(value *AutoscalingGroupPolicy) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (a *jsiiProxy_AutoscalingGroup) validatePutReplicaConfigurationParameters(value *AutoscalingGroupReplicaConfiguration) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (j *jsiiProxy_AutoscalingGroup) validateSetDatacenterIdParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_AutoscalingGroup) validateSetMinReplicaCountParameters(val *float64) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
