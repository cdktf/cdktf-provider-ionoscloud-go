...
func (a *jsiiProxy_AutoscalingGroupReplicaConfigurationVolumeList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (a *jsiiProxy_AutoscalingGroupReplicaConfigurationVolumeList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
