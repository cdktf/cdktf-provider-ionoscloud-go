...
func (a *jsiiProxy_AutoscalingGroupPolicyScaleOutActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutoscalingGroupPolicyScaleOutActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
