...
type AutoscalingGroup interface {
	...
	PolicyInput() *AutoscalingGroupPolicy
	// Experimental.
	...
	ReplicaConfiguration() AutoscalingGroupReplicaConfigurationOutputReference
	ReplicaConfigurationInput() *AutoscalingGroupReplicaConfiguration
	// Experimental.
	...
	PutPolicy(value *AutoscalingGroupPolicy)
	PutReplicaConfiguration(value *AutoscalingGroupReplicaConfiguration)
...
func (j *jsiiProxy_AutoscalingGroup) DatacenterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datacenterId",
...
func (j *jsiiProxy_AutoscalingGroup) DatacenterIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datacenterIdInput",
...
func (j *jsiiProxy_AutoscalingGroup) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_AutoscalingGroup) MaxReplicaCountInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AutoscalingGroup) MinReplicaCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"minReplicaCount",
...
func (j *jsiiProxy_AutoscalingGroup) MinReplicaCountInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AutoscalingGroup) Policy() AutoscalingGroupPolicyOutputReference {
	var returns AutoscalingGroupPolicyOutputReference
	_jsii_.Get(
		j,
		"policy",
		&returns,
...
func (j *jsiiProxy_AutoscalingGroup) PolicyInput() *AutoscalingGroupPolicy {
...
func (j *jsiiProxy_AutoscalingGroup) ReplicaConfiguration() AutoscalingGroupReplicaConfigurationOutputReference {
	var returns AutoscalingGroupReplicaConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AutoscalingGroup) ReplicaConfigurationInput() *AutoscalingGroupReplicaConfiguration {
...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.4.17/docs/resources/autoscaling_group ionoscloud_autoscaling_group} Resource.
...
func (j *jsiiProxy_AutoscalingGroup)SetDatacenterId(val *string) {
...
func (j *jsiiProxy_AutoscalingGroup)SetMaxReplicaCount(val *float64) {
...
func (j *jsiiProxy_AutoscalingGroup)SetMinReplicaCount(val *float64) {
...
func (a *jsiiProxy_AutoscalingGroup) PutPolicy(value *AutoscalingGroupPolicy) {
...
func (a *jsiiProxy_AutoscalingGroup) PutReplicaConfiguration(value *AutoscalingGroupReplicaConfiguration) {
	if err := a.validatePutReplicaConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
