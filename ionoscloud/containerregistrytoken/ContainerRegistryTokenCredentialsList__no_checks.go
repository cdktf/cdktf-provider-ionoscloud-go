...
func (c *jsiiProxy_ContainerRegistryTokenCredentialsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (c *jsiiProxy_ContainerRegistryTokenCredentialsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
