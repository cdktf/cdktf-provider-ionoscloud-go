...
type ApigatewayCustomDomains struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.14/docs/resources/apigateway#certificate_id Apigateway#certificate_id}
