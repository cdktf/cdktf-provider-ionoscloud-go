...
import (
	...
	"github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v11/dnszone/internal"
...
type DnsZone interface {
	...
	PutTimeouts(value *DnsZoneTimeouts)
	ResetDescription()
	ResetEnabled()
	ResetId()
...
func (j *jsiiProxy_DnsZone) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_DnsZone) EnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledInput",
...
func (j *jsiiProxy_DnsZone) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DnsZone) Nameservers() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"nameservers",
...
func (j *jsiiProxy_DnsZone) Timeouts() DnsZoneTimeoutsOutputReference {
	var returns DnsZoneTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_DnsZone) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func NewDnsZone(scope constructs.Construct, id *string, config *DnsZoneConfig) DnsZone {
	...
	_jsii_.Create(
		"@cdktf/provider-ionoscloud.dnsZone.DnsZone",
...
func (j *jsiiProxy_DnsZone)SetEnabled(val interface{}) {
...
func (j *jsiiProxy_DnsZone)SetId(val *string) {
...
func (d *jsiiProxy_DnsZone) PutTimeouts(value *DnsZoneTimeouts) {
...
func (d *jsiiProxy_DnsZone) ResetEnabled() {
	_jsii_.InvokeVoid(
		d,
		"resetEnabled",
		nil, // no parameters
...
func (d *jsiiProxy_DnsZone) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DnsZone) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
