...
import (
	...
	"github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12/user/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.13/docs/resources/user ionoscloud_user}.
type User interface {
...
func (j *jsiiProxy_User) PasswordWo() *string {
	var returns *string
	_jsii_.Get(
		j,
		"passwordWo",
...
func (j *jsiiProxy_User) PasswordWoInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"passwordWoInput",
...
func (j *jsiiProxy_User) PasswordWoVersion() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"passwordWoVersion",
...
func (j *jsiiProxy_User) PasswordWoVersionInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.13/docs/resources/user ionoscloud_user} Resource.
...
func (j *jsiiProxy_User)SetPasswordWo(val *string) {
...
func (j *jsiiProxy_User)SetPasswordWoVersion(val *float64) {
...
func (u *jsiiProxy_User) ResetPasswordWo() {
	_jsii_.InvokeVoid(
		u,
		"resetPasswordWo",
		nil, // no parameters
...
func (u *jsiiProxy_User) ResetPasswordWoVersion() {
	_jsii_.InvokeVoid(
		u,
		"resetPasswordWoVersion",
		nil, // no parameters
