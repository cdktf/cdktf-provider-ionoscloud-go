...
func (j *jsiiProxy_DataIonoscloudApplicationLoadbalancerForwardingrule) Count() interface{} {
...
func (j *jsiiProxy_DataIonoscloudApplicationLoadbalancerForwardingrule)SetCount(val interface{}) {
...
func DataIonoscloudApplicationLoadbalancerForwardingrule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataIonoscloudApplicationLoadbalancerForwardingrule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataIonoscloudApplicationLoadbalancerForwardingrule_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataIonoscloudApplicationLoadbalancerForwardingrule_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataIonoscloudApplicationLoadbalancerForwardingrule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataIonoscloudApplicationLoadbalancerForwardingrule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataIonoscloudApplicationLoadbalancerForwardingrule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataIonoscloudApplicationLoadbalancerForwardingrule) ToHclTerraform() interface{} {
	var returns interface{}
