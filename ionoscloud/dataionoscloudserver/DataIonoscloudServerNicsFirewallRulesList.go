...
func (d *jsiiProxy_DataIonoscloudServerNicsFirewallRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataIonoscloudServerNicsFirewallRulesList) Resolve(context cdktf.IResolveContext) interface{} {
