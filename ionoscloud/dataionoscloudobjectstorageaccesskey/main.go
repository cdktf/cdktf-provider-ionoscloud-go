...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataIonoscloudObjectStorageAccesskey)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.dataIonoscloudObjectStorageAccesskey.DataIonoscloudObjectStorageAccesskeyConfig",
		reflect.TypeOf((*DataIonoscloudObjectStorageAccesskeyConfig)(nil)).Elem(),
	)
}
