...
func (d *jsiiProxy_DataIonoscloudPgBackupsClusterBackupsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataIonoscloudPgBackupsClusterBackupsList) Resolve(context cdktf.IResolveContext) interface{} {
