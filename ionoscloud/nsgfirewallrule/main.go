...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NsgFirewallrule)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.nsgFirewallrule.NsgFirewallruleConfig",
		reflect.TypeOf((*NsgFirewallruleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-ionoscloud.nsgFirewallrule.NsgFirewallruleTimeouts",
		reflect.TypeOf((*NsgFirewallruleTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-ionoscloud.nsgFirewallrule.NsgFirewallruleTimeoutsOutputReference",
		reflect.TypeOf((*NsgFirewallruleTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
