...
func (d *jsiiProxy_DataIonoscloudLanIpFailoverList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataIonoscloudLanIpFailoverList) Resolve(context cdktf.IResolveContext) interface{} {
